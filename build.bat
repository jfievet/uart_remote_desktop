...
gcc -std=c11 -Wall -Wextra -D_WIN32_WINNT=0x0600 -DWINVER=0x0600 -I"%INCLUDE%" -I"%ROOT%third_party\stb" "%SRC%\sender.c" "%SRC%\capture.c" "%SRC%\input.c" "%SRC%\protocol.c" "%SRC%\transport_tcp.c" "%SRC%\transport_uart.c" "%SRC%\wic_jpeg.c" -o "%ROOT%bin\sender.exe" -lws2_32 -lgdi32 -lgdiplus -luser32 -lole32 -loleaut32
